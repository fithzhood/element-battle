...
class Game {
    ...
    askZip() {
        ...
        input.onchange = e => { const f = e.target.files && e.target.files[0]; if (f) this.loadZip(f); };
        input.click();
    }
